...
export default function Hero3D() {
  ...
  // Render a dark void while the system interrogates the user's graphics card
  if (!gpuTier) {
    return <div className="h-screen w-full absolute inset-0 z-0 bg-[#030303]" />;
  }

  // THE LOGIC GATE: Mobile devices or weak GPUs get the static fallback
  const isMobileOrWeak = gpuTier.isMobile || gpuTier.tier < 2;
